...
public enum cardtype {
	...
	COPPER("Treasure", "Copper", "Coin with Value 1", 1, 0, 0, "http://i.imgur.com/3qBu0jv.jpg?1"), SILVER(
			"Treasure", "Silver", "", 2, 3, 0, "http://i.imgur.com/dxSJ4M1.jpg?1 "), GOLD("Treasure", "Gold", "",
					3, 6, 0, "http://i.imgur.com/CidYwq3.png?1"),
	/*
	 * VICTORY
	 */
	ESTATE("Victory", "Estate", "", 0, 2, 1, "http://i.imgur.com/gHNS5dO.jpg?1 "), DUTCHY("Victory", "Dutchy", "",
			0, 5, 3, "http://i.imgur.com/qLMQ0Pk.jpg?1"), PROVINCE("Victory", "Province", "", 0, 8, 6,
					"http://i.imgur.com/A8WzRRu.jpg?1"),
	/*
	 * ACTION
	 */
